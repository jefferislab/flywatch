...
pvals<-filter(pvals, Genotype!="LH235")
pvals<-filter(pvals, Genotype!="LH2158")
pvals<-filter(pvals, Genotype!="LH2013")
pvals<-filter(pvals, Genotype!="LH16")
pvals<-filter(pvals, Genotype!="LH16")
pvals<-filter(pvals, Genotype!="LH1806")
pvals<-filter(pvals, Genotype!="LH1965")
pvals<-filter(pvals, Genotype!="LH1966")
pvals<-filter(pvals, Genotype!="LH283")
pvals<-filter(pvals, Genotype!="LH371")
pvals<-filter(pvals, Genotype!="LH545")
pvals<-filter(pvals, Genotype!="LH574")
pvals<-filter(pvals, Genotype!="LH62")
pvals<-filter(pvals, Genotype!="LH784")
pvals<-filter(pvals, Genotype!="test")
pvals<-filter(pvals, Genotype!="SS00502")
pvals<-filter(pvals, Genotype!="SS01262")
